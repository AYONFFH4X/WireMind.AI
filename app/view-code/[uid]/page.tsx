...
import SelectionDetail from '../_components/SelectionDeatails'
...
function ViewCode() {
    ...
    const GetRecordInfo = async (regen = false) => {
        ...
        const result = await axios.get('/api/wireframe-t-code?uid=' + uid)
    ...
    const GenerateCode = async (record: RECORD) => {
        ...
        while (true) {
            ...
            setCodeResp((prev: any) => prev + text);
            console.log(text);
    ...
    const UpdateCodeToDb = async () => {
        console.log(record)
        const result = await axios.put('/api/wireframe-t-code', {
            uid: record?.uid,
